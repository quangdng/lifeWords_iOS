...
- (void)fetchImageWithUrl:(NSString *)stringUrl
{
  ...
  //Local image
    if ([stringUrl hasSuffix:@"/card_photo.jpg"]) {
        self.imageView.image = [UIImage imageWithData:UIImageJPEGRepresentation([UIImage imageWithContentsOfFile:stringUrl], 0.5)];
